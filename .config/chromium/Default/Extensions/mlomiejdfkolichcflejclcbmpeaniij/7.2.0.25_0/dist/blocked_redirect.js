...
var msg = require('./utils/msg')('blocked_redirect'),
    sendMessage = msg.sendMessageInPromise,
    APP_ID = 0,
    URL = '';

(function BlockedRedirect(window, document, undefined) {
	...
	function setupDocument(blockedRedirectData) {
		...
		var translations = blockedRedirectData.translations,
		    blacklisted = blockedRedirectData.blacklisted;
		...
		document.getElementById('action-always').firstChild.title = translations.blocked_redirect_action_always_title;
		document.getElementById('action-through-once').firstChild.title = translations.blocked_redirect_action_through_once_title;
	...
	window.addEventListener('load', function () {
		...
		var button1 = document.getElementById("action-through-once");
		if (button1) {
			button1.addEventListener("click", function (e) {
				sendMessage('allow_once_page_c2p_tracker', {
					app_id: APP_ID,
					url: URL
				});
				e.preventDefault();
		...
		var button2 = document.getElementById("action-always");
		if (button2) {
			button2.addEventListener("click", function (e) {
				sendMessage('allow_always_page_c2p_tracker', {
					app_id: APP_ID,
					url: URL
				});
				e.preventDefault();
	...
	sendMessage("getBlockedRedirectData").then(setupDocument);
})(window, document);
...
//# sourceMappingURL=blocked_redirect.js.map
