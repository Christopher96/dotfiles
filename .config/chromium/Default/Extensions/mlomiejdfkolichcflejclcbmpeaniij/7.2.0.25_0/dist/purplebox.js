...
var Ghostery = function (win, doc) {
	...
	var ghostery, box, count, pbIcons, breakingIcon, slowIcon, nonSecureIcon, nonSecureSlowIcon, title, minimizeContainer, minimizeIcon, close, background, list;
	...
	var createTrackerDiv = function (app) {
		var icon,
		    dup,
		    hasIcon = false,
		    liDiv = createEl("div"),
	...
	var handleNewTrackers = function (apps) {
		var trackersText = title;
		var trackers = list.childNodes;
		...
		var newCount = list.childNodes.length;
	...
	var channelsSupported = typeof chrome.runtime.connect === 'function';
