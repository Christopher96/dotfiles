...
var msg = require('./utils/msg')('setup'),
    log = msg.log;

var SetupPage = function (window, document, undefined) {

  var _initialize = function () {
    log('Legacy settings page. Redirecting...');

    window.dispatchEvent(new window.Event('extensionFound'));
    window.location = 'https://extension.ghostery.com/settings';
  };
