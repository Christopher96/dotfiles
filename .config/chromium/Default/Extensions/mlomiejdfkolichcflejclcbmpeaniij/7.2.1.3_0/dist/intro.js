...
var msg = require('./utils/msg')('intro'),
    sendMessage = msg.sendMessage;

var IntroPage = function (window, document, undefined) {

	var _initialize = function () {
		var button = document.getElementById("buttonWelcome");
		if (button) {
			button.addEventListener("click", function (e) {
				sendMessage('tour_start');
			});
		}

		sendMessage('introLoaded');
	};
