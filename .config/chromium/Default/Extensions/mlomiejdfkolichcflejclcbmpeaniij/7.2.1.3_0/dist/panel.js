...
var PanelView = ParentView.extend({
	...
	clickPrivacyStatement: function () {
		this.sendMessage('openNewTab', {
			url: 'https://www.ghostery.com/about-ghostery/browser-extension-privacy-policy/',
			become_active: false
		});
		window.close();
	},
